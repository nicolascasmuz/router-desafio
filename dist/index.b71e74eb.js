...
var _sent = require("../components/sent");
var _inboxMail = require("../components/inbox-mail");
var _sentMail = require("../components/sent-mail");
function handleRoute(route) {
    const routes = [
        {
            path: /\//,
            handler: (0, _inbox.inboxComp)
        },
        {
            path: /\/inbox/,
            handler: (0, _inbox.inboxComp)
        ...
        {
            path: /\/sent/,
            handler: (0, _sent.sentComp)
        },
        {
            path: /\/inbox\/mail/,
            handler: (0, _inboxMail.mailInboxComp)
        },
        {
            path: /\/sent\/mail/,
            handler: (0, _sentMail.mailSentComp)
        }, 
    ];
...
function main(content = document) {
    const homeEl = document.querySelector(".header__link-logo");
    ...
    for (const link of buttonsEl)link.addEventListener("click", (e)=>{
        e.preventDefault();
        const route = e.target.getAttribute("href");
        goTo(route);
        if (link.textContent == "Inbox") link.style.backgroundColor = "#393939";
        else if (link.textContent == "Sent") link.style.backgroundColor = "#393939";
    });
    const mailInboxEl = content.querySelectorAll(".section-inbox__enter");
    for (const link1 of mailInboxEl)link1.addEventListener("click", (e)=>{
        e.preventDefault();
        const route = e.target.getAttribute("href");
        goTo(route);
    });
    const mailSentEl = content.querySelectorAll(".section-sent__enter");
    for (const link2 of mailSentEl)link2.addEventListener("click", (e)=>{
        e.preventDefault();
        const route = e.target.getAttribute("href");
        goTo(route);
    });
    const buscarEl = document.querySelector(".header__button");
...
},{"../components/inbox":"3OiJZ","../components/sent":"h9ZoC","../components/inbox-mail":"bFhV2","../components/sent-mail":"e8Ffc"}],"3OiJZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "inboxComp", ()=>inboxComp);
function inboxComp() {
...
},{}],"h9ZoC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sentComp", ()=>sentComp);
function sentComp() {
    const addEl = document.createElement("div");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bFhV2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mailInboxComp", ()=>mailInboxComp);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e8Ffc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mailSentComp", ()=>mailSentComp);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iJYvl","h7u1C"], "h7u1C", "parcelRequired917")
